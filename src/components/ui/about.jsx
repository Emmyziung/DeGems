...
<ol className="list-decimal text text-lg text-slate-700 max-w-3xl mx-auto mb-6 px-4">
    ...
    <li>&nbsp;Gem Oladipupo Olabinjo – Chief Whip
</li>
...
<ol className="list-decimal text text-lg text-slate-700 max-w-3xl mx-auto mb-6 px-4">
    ...
    <li>&nbsp;Gem Kehinde Awoyemi – Treasurer</li>
    <li>&nbsp;Gem Abayomi Osinowo – Social Secretary</li>
    <li>&nbsp;Gem Adeboye Elepe – Chief Whip</li>
...
<ul className="list-disc text-lg text-slate-700 max-w-3xl mx-auto mb-6 px-4">
    ...
    <li>&nbsp;Contributions to the Iperu community through impactful social initiatives and civic engagement</li>
</ul>
